...
const TREE = {
  ...
  visa_visit_transit_en: { type: "question", service: "visa", breadcrumb: ["Home", "Visa", "No Korean Heritage", "Visiting / Transit"], question: "What type of visit?", sub: "🇨🇦 Canadian passport holders are visa-free for up to 6 months. K-ETA is currently exempted for Canadians until December 31, 2026.", options: [{ id: "visa_visit_en", icon: "✈️", title: "Tourism / Short-Term Stay", desc: "Sightseeing, visiting friends, medical tourism — no visa needed for Canadians" },{ id: "visa_transit_en", icon: "🔄", title: "Transit Without Visa (TWOV)", desc: "Passing through Korea on the way to another country — up to 30 days" },{ id: "visa_keta_en", icon: "📱", title: "K-ETA — Do I need one?", desc: "Canadians currently exempted until Dec 31, 2026" }] },
