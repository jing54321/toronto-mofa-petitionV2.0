...
const TREE = {
  ...
  family_cert_visit_direct: {
    ...
    docs: [
      ...
      "  └ 직계가족(조부모·부모·자녀·손자·배우자)이 대신 신청하는데 신청대상자가 혼인 전 외국국적 취득으로 국적상실한 경우: 가족관계등록부(제적등본)에 배우자·자녀 등이 표시되지 않으므로 가족관계 확인용 추가 서류가 필요합니다.",
      "  └ 예) 1985년 캐나다 시민권 취득 후 1990년 캐나다에서 혼인한 경우 — 배우자 이름이 가족관계등록부에 없으므로, 캐나다 정부 발행 혼인증명(Marriage Certificate) 원본 + 한글 번역문 제출 (공증 불필요, 본인 번역 가능).",
      ...
      "우편 수령용 등기봉투 (선택)",
      "  └ XpressPost Prepaid Envelope — 방문 수령 대신 우편으로 받고 싶은 경우 제출 (Canada Post 구매)",
    ],
...
const EN_TRANSLATIONS: any = {
  ...
  family_cert_visit_direct: {
    ...
    docs: [
      ...
      "  └ If an immediate family member (grandparent, parent, child, grandchild, spouse) applies on the subject's behalf and the subject lost nationality by acquiring a foreign nationality before marriage: the spouse/children may not appear in the family register (removed register), so additional documents confirming the relationship are needed.",
      "  └ e.g. If citizenship was acquired in 1985 and marriage took place in Canada in 1990 — the spouse's name won't appear in the family register, so submit the original Canadian Marriage Certificate + Korean translation (no notarization needed, self-translation allowed).",
      ...
      "  └ Xpresspost Prepaid Envelope — if you'd like the certificate mailed instead of picked up (buy at Canada Post)",
    ],
