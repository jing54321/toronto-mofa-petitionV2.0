...
const TREE = {
  ...
  visa_short_term_ko: { type: "question", service: "visa", breadcrumb: ["Home", "Visa", "No Korean Heritage", "Short Term Visit"], question: "What is the purpose of your short-term visit?", sub: "🇨🇦 Canadian citizens can visit Korea visa-free for up to 6 months — you may NOT need a visa. A short-term visa (C-3) is mainly required for non-Canadian nationals residing in Canada, or for specific activities.", options: [{ id: "visa_c34_ko", icon: "🤝", title: "Business Trip (C-3-4)", desc: "Market research, contract signing, consulting, meetings with Korean companies" },{ id: "visa_c31_ko", icon: "📋", title: "General Short-Term Visit (C-3-1)", desc: "Conference, academic research, medical treatment, training, religious activities" },{ id: "visa_c33_ko", icon: "🏥", title: "Medical Treatment (C-3-3)", desc: "Non-Canadians visiting Korea for medical treatment — up to 90 days" },{ id: "visa_c39_ko", icon: "🎭", title: "Culture / Arts / Sports (C-3-9)", desc: "Performing arts, sports competitions, cultural exchanges" }] },
...
const page = (TREE as any)[pageId] ?? { type: "home" };
  ...
  const EN_ROUTE_MAP = {
    ...
    visa_start_ko: "visa_start_en",
    visa_heritage_yes_ko: "visa_heritage_yes_en",
    visa_heritage_unsure_ko: "visa_heritage_unsure_en",
    visa_heritage_no_ko: "visa_heritage_no_en",
    visa_dual_check_ko: "visa_dual_check_en",
    ...
    visa_f4_family_ko: "visa_f4_family_en",
    visa_f3_spouse_ko: "visa_f3_spouse_en",
    visa_f3_child_ko: "visa_f3_child_en",
    visa_c3_start_ko: "visa_c3_start_en",
    visa_c3_family_ko: "visa_c3_family_en",
    visa_c3_emergency_ko: "visa_c3_emergency_en",
    visa_c3_other_ko: "visa_c3_other_en",
    visa_no_heritage_ko: "visa_no_heritage_en",
    ...
    visa_keta_ko: "visa_keta_en",
    visa_visit_transit_ko: "visa_visit_transit_en",
    ...
    visa_c31_ko: "visa_c31_en",
    visa_c39_ko: "visa_c39_en",
