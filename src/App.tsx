...
const TREE = {
  ...
  family_cert_visit_direct: {
    ...
    docs: [
      ...
      "  └ 양식 작성 후 가족(4촌 이내) 2명 서명하여 제출",
      "Marriage Certificate 원본+사본 (해당자만)",
      "  └ 한국에 혼인신고가 안 되어 있고 캐나다 신분증상 남편 성을 따른 경우에만 제출 (동일인확인서와 함께)",
      "  └ 남편 성을 따르지 않았거나, 따랐더라도 한국에 혼인신고가 되어 있으면 제출 불필요 (동일인확인서만 제출)",
      "우편 수령용 등기봉투 (선택)",
      "  └ XpressPost Prepaid Envelope — 우편으로 수령을 원하는 경우 제출 (직접 수령 시 제출 불필요, Canada Post에서 구매 가능)",
    ],
    costs: [{ label: "통당 수수료", value: "CAD $1.30 (현금, Debit, 신용카드)" }],
    time: "약 2주 (발급 완료 후 별도 안내 전화 없음 — 예정일에 방문 수령)",
    notices: [
      "방문 예약 필수: torbooking.com",
      "직계가족(조부모·부모·자녀·손자·배우자)은 위임장 없이 신청 가능 — 단, 방문예약은 신청 건수만큼 각각 필요.",
      "  ▸ 예) 모가 방문하여 본인과 자녀 2명의 증명서를 각각 발급받는 경우 → 3명분 신청이므로 3자리 각각 예약.",
  ...
  family_birth_both_korean: {
    ...
    docs: [
      ...
      "출생신고서 (양식) — 반드시 양식 내 작성예시 참고",
      "  └ 한자 이름이 있는 경우 한자도 함께 기재, '본'도 한자로 작성",
      ...
      "  └ 한국 국적자는 본인의 등록기준지를 정확히 알고 기재 — 기본증명서 상단에 표시됨",
      "  └ 기타란: '외국성명: 스미스제임스길동' 형식으로 캐나다 출생증명서상 이름 한글로 기재",
      "출생증명서 원본 1부 (반환 불가, 부/모 이름이 반드시 나와있어야 함)",
    ...
    notices: [
      ...
      "⚠️ 부/모 등록기준지는 자녀 출생 당시 국적 기준 — 출생 당시 한국적이면 본적 정확히, 외국적이면 해당 국적명 기재 (오기 시 반송).",
      "한자 이름 사용 시: 반드시 대법원 인명용 한자 사용 (비인명용 한자 등록 불가) — 인명용 한자: efamily.scourt.go.kr",
      "자녀 이름은 원칙적으로 최대 5자 이내.",
      "부 또는 모가 복수국적자인 경우: 모든 국가 유효 여권 사본 제출.",
      "출생증명서 원본은 한국으로 송부되며 반환되지 않습니다.",
      "단순 양식 작성 방법 등에 대한 문의는 방문 시 담당 직원에게 직접 문의해 주세요.",
    ],
    booking: "https://www.torbooking.com/book",
  ...
  family_birth_father_korean: {
    ...
    docs: [
      ...
      "  └ 방문하는 부/모만 원본 제출(확인 후 즉시 반환), 미방문자는 사본만 제출",
      "부·모 캐나다 체류자격 증명서류 사본 각 1부",
      "  └ 방문자: 체류비자 / 영주권자: PR카드 앞면 / 시민권자: 시민권증서 (Search of Citizenship Record·카드형 불가, 선서일 년월일 표시, Letter 사이즈 용지) / 캐나다 출생 시민권자: Birth Certificate (Short/Long form 무관)"
    ],
    costs: [{ label: "수수료", value: "무료" }],
    time: "약 4주",
    notices: [
      ...
      "외국인 모의 성을 따르는 경우: 성은 한자 기재 불가, 이름은 한자 기재 가능 (인명용 한자: efamily.scourt.go.kr).",
      "출생증명서 원본은 반환되지 않습니다.",
  ...
  family_marriage: {
    ...
    question: "두 분의 국적은 어떻게 되시나요?",
    options: [
      { id: "family_marriage_korean", icon: "🪪", title: "두 사람 모두 한국 국적자", desc: "두 분 모두 한국 국적인 경우" },
      { id: "family_marriage_mixed", icon: "🌏", title: "두 사람 중 1명만 한국 국적자 (배우자가 외국인)", desc: "한국인 + 외국인 조합" },
    ],
  },
  ...
  family_divorce: {
    ...
    question: "두 분의 국적은 어떻게 되시나요?",
    sub: "⚠️ 이혼판결일 기준 두 사람 모두 캐나다 국적이면 이혼신고가 불가능합니다 (국적상실신고만 가능).",
    options: [
      { id: "family_divorce_agreement", icon: "🤝", title: "두 사람 모두 한국 국적자", desc: "협의이혼의사확인 신청 — 약 6개월 (캐나다 법원 이혼했다면 재판이혼으로도 신고 가능)" },
      { id: "family_divorce_court", icon: "⚖️", title: "두 사람 중 1명만 한국 국적자", desc: "캐나다 법원 이혼 후 재판이혼 신고 — 약 3~4주" },
    ],
  },
  ...
  family_divorce_court: {
    ...
    docs: [
      "전자적송부신청서 (양식) — 카카오톡 연결 전화번호 기재 시 접수·완료 알림 수신",
      "이혼신고서 (양식) — 한글·아라비아숫자만 기재",
      "  └ 등록기준지(본적) 정확히 기재 (미기재·오기재 시 반송될 수 있음)",
      "  └ 캐나다 현지 주소는 한글로 소리나는 대로 기재 (예: 온타리오주 토론토시 애비뉴로드 555번지)",
      "  └ 증인란은 기재 불요",
      "  └ 재판확정일자: 판결일이 아닌 효력발생일 기재 (일반적으로 판결일로부터 한 달 뒤)",
      "  └ 친권: 판결문에 Custody 미기재 시 친권란 공란 (등록 원하면 판결문에 Custody 명시 필요)",
      "이혼증명서 (Certificate of Divorce) 원본 등본 1부 (반환 불가)",
      "└ 온타리오 이혼증명서 예시",
      "이혼증명서 한글 번역문 1부 — 신고인 직접 번역 또는 번역사무소 이용 (공증 불필요), 하단에 번역일자·이름·서명",
      "이혼판결문 (Certificate of Judgement 또는 Divorce Order) 원본 등본 1부 (반환 불가)",
      "└ 온타리오 이혼판결문 예시",
      "이혼판결문 한글 번역문 1부 — 신고인 직접 번역 또는 번역사무소 이용 (공증 불필요), 하단에 번역일자·이름·서명",
      "Separation Agreement 원본 등본 + 번역문 (미성년 자녀 있는 경우만 — 판결문에 양육권 상세 기재 시 불요)",
      "이혼 당사자 여권 사본 각 1부 (유효한 여권, 원본은 방문 신고 당사자만 확인 후 즉시 반환)",
      "신고 당사자 체류자격 증명서류 사본 1부",
      "  └ 방문자: 체류비자 / 영주권자: PR카드 / 시민권자: 시민권증서 / 캐나다 출생 시민권자: Birth Certificate(Long/Short 무관) / 국적회복 복수국적자: 국적회복증서 또는 국적회복 표시 기본증명서",
    ...
    notices: [
      ...
      "  ▸ 예) 혼인 당시엔 한국국적자였으나 이혼판결 당시 캐나다 시민권을 취득한 경우: 그 사람은 신고 불가 — 한국국적을 보유한 배우자가 신고인이 되어야 합니다. 두 사람 모두 이혼판결 당시 캐나다 국적자라면 이혼신고 자체가 불가능합니다 (국적상실신고만 가능).",
      "⚠️ 온타리오·마니토바주 법원 발행 서류만 제출 가능 — 추가 등본이 필요하면 관할 법원에 재신청 가능.",
      "우편 접수 가능 — 신고서 서명은 이혼 당사자 중 1명 이상이 직접 하면 됩니다 (배우자와 연락이 닿지 않으면 본인만 서명해도 무방).",
      "우편 접수 시 여권·체류자격 증명서류는 사본만 제출하면 되며 공증이 필요하지 않습니다.",
      "본(本): 이혼 당사자의 본을 한자로 기재 (예: 김해 김씨 → 金海, 외국인은 공란).",
      "이혼증명서·판결문 원본은 반환되지 않으며, 그 외 원본(여권·체류자격서류 등)은 확인 후 즉시 반환됩니다.",
      "캐나다 내 이혼 절차 자체에 대한 자세한 안내는 캐나다 현지 변호사 또는 관할 법원에 문의하세요.",
      "서류 심사 후 필요 시 구비서류가 추가되거나 줄어들 수 있습니다.",
    ],
    booking: "https://www.torbooking.com/book",
  ...
  family_recognition: {
    ...
    docs: [
      ...
      "  ▸ 방문자: 체류비자 / 영주권자: PR카드 / 시민권자: 시민권증서 / 캐나다 출생 시민권자: Birth Certificate",
    ],
    costs: [{ label: "수수료", value: "무료" }],
    time: "약 3~4주",
    notices: [
  ...
  visa_f4_case1_en: {
    ...
    docs: [
      ...
      "  ▸ If a parent is deceased: submit death certificate instead — if the death was reported in Korea, submit a basic certificate (detailed) + family relation certificate (detailed); if the parent died as a Canadian citizen, submit the original Death Certificate",
...
const KO_TRANSLATIONS = {
  ...
  visa_f4_case1_en: {
    ...
    docs: [
      ...
      "부모 양쪽 여권 사본",
      "  ▸ 부모 중 사망한 분이 있으면: 사망증명서로 대체 — 한국에 사망신고 완료 시 기본증명서(상세)+가족관계증명서(상세), 캐나다 시민권자로 사망 시 사망진단서(Death Certificate) 원본 제출",
      "캐나다 시민권증서 — 원본 + 사본",
...
const EN_TRANSLATIONS: any = {
  ...
  family_cert_visit_direct: {
    ...
    docs: [
      ...
      "  └ Only if the marriage is unreported in Korea AND you took your husband's surname on your Canadian ID (submit together with the identity confirmation statement)",
      ...
      "Return-by-mail registered envelope (optional)",
      "  └ Xpresspost Prepaid Envelope — submit if you'd like the certificate mailed (not required if picking up in person; buy at Canada Post)",
    ],
    ...
    notices: [
      "Appointment required: torbooking.com",
      "Immediate family (grandparents, parents, children, grandchildren, spouse) may apply without a power of attorney — but a separate appointment is needed for each application.",
      "  ▸ e.g. If a mother visits to obtain certificates for herself and her 2 children, that's 3 applications, so 3 separate appointment slots are needed.",
      "Siblings and daughters-in-law are not immediate family.",
  ...
  family_birth_both_korean: {
    ...
    docs: [
      ...
      "Birth report form (form) — be sure to follow the sample entry in the form",
      "  └ If the child has a Chinese-character name, include it, and write the origin (bon) in Chinese characters too",
      ...
      "  └ Korean nationals should know and state their own registration base address accurately — it's shown at the top of the basic certificate",
      "  └ Remarks field: write the Canadian birth-certificate name in Korean as 'Foreign name: 스미스제임스길동'",
      "Birth certificate original, 1 copy (non-returnable, must show the parents' names)",
    ...
    notices: [
      ...
      "For simple questions about how to fill out the form, please ask staff directly when you visit.",
    ],
  ...
  family_birth_father_korean: {
    ...
    docs: [
      ...
      "  └ The Korean parent should know and state their own registration base address accurately — it's shown at the top of the basic certificate",
  ...
  family_marriage: {
    ...
    question: "What is your nationality situation as a couple?",
    options: {
      family_marriage_korean: { title: "Both parties are Korean nationals", desc: "When both hold Korean nationality" },
      family_marriage_mixed: { title: "Only 1 of the 2 is a Korean national (spouse is foreign)", desc: "Korean + foreigner combination" },
    },
  },
  family_marriage_korean: {
  ...
  family_divorce: {
    ...
    question: "What is your nationality situation as a couple?",
    sub: "⚠️ If both parties hold only Canadian nationality as of the divorce judgment date, a divorce report cannot be filed (only a nationality-loss report is possible).",
    options: {
      family_divorce_agreement: { title: "Both parties are Korean nationals", desc: "Confirmation of divorce by agreement — about 6 months (if already divorced in a Canadian court, you may also report via judicial divorce)" },
      family_divorce_court: { title: "Only 1 of the 2 is a Korean national", desc: "Report after a Canadian court divorce — about 3–4 weeks" },
    },
  },
  family_divorce_agreement: {
  ...
  family_divorce_court: {
    ...
    docs: [
      "Electronic transmission application (form) — providing a KakaoTalk-linked phone number allows you to receive receipt/completion alerts",
      "Divorce report form (form) — use only Korean and Arabic numerals",
      "  └ State the registration base address (bonjeok) accurately (missing/incorrect entry may cause the report to be returned)",
      "  └ Write your Canadian address phonetically in Korean (e.g., 555 Avenue Road, Toronto, Ontario)",
      "  └ The witness field does not need to be filled in",
      "  └ Judgment finalization date: write the effective date, not the judgment date (generally one month after the judgment)",
      "  └ Custody: if Custody is not stated in the judgment, leave the custody field blank (to register custody, the judgment must explicitly state Custody)",
      "Certificate of Divorce original copy, 1 (non-returnable)",
      "└ Ontario Certificate of Divorce sample",
      "Korean translation of the Certificate of Divorce, 1 — translated by the reporter or a translation service (no notarization needed); date, translator's name, and signature at the bottom",
      "Divorce judgment (Certificate of Judgement or Divorce Order) original copy, 1 (non-returnable)",
      "└ Ontario divorce judgment sample",
      "Korean translation of the divorce judgment, 1 — translated by the reporter or a translation service (no notarization needed); date, translator's name, and signature at the bottom",
      "Separation Agreement original copy + translation (only if there are minor children; not needed if detailed custody is stated in the judgment)",
      "Both parties' passport copies, 1 each (must be valid; originals are checked only from the party visiting in person and returned immediately)",
      "Reporter's residency-status proof copy, 1",
      "  └ Visitor: temporary visa / PR: PR Card / Citizen: Certificate of Citizenship / Canadian-born citizen: Birth Certificate (Long/Short form both accepted) / Dual national who restored nationality: Certificate of Nationality Restoration or a basic certificate showing the restoration",
      "Identity confirmation statement (if applicable) — if the name was changed",
      "  └ Signatures of 2 family members required",
    ],
    costs: [{ label: "Fee", value: "Free" }],
    time: "About 3 weeks",
    notices: [
      ...
      "  ▸ e.g. If a party was a Korean national at marriage but had acquired Canadian citizenship by the time of the divorce judgment: that person cannot be the reporter — the spouse who holds Korean nationality must be the reporter. If both parties were Canadian nationals only as of the judgment date, a divorce report cannot be filed at all (only a nationality-loss report is possible).",
      "⚠️ Only documents issued by Ontario/Manitoba courts may be submitted — if you need additional certified copies, you can reapply at the relevant court.",
      "Mail submission allowed — the report form must be signed by at least 1 of the two divorced parties (if you cannot reach your ex-spouse, your own signature alone is sufficient).",
      "For mail submission, passport and residency-status documents only need to be submitted as copies — no notarization is required.",
      "Origin (bon): write the parties' origin in Chinese characters (e.g., Gimhae Kim → 金海; blank for a foreigner).",
      "The divorce certificate/judgment originals are not returned; other originals (passport, residency-status documents, etc.) are checked and returned immediately.",
      "For details on the Canadian divorce process itself, consult a local lawyer or the relevant court.",
      "Required documents may be added or reduced after document review.",
    ],
...
function AppInner() {
  ...
  const [lookupInfo, setLookupInfo] = useState({ name: "", email: "", phone: "" });
  const [lookupList, setLookupList] = useState<any[] | null>(null);
  const [lookupOpen, setLookupOpen] = useState<number | null>(null);
                  ...
                  <div className="info-card-body" style={{ padding: "16px" }}>
                    ...
                    {[["name", "이름", "Name"], ["email", "이메일", "Email"], ["phone", "전화번호", "Phone"]].map(([k, ko, en]) => (
                      <input key={k} value={(lookupInfo as any)[k]}
                        onChange={(e) => setLookupInfo({ ...lookupInfo, [k]: e.target.value })}
                    ...
                    {lookupList && lookupList.length > 0 && (
                      <div style={{ marginTop: "14px" }}>
                        <div style={{ fontSize: "12px", color: "#8a94a8", marginBottom: "8px" }}>{lang === "ko" ? `조회 결과 ${lookupList.length}건` : `${lookupList.length} result(s)`}</div>
                        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                          {lookupList.map((item: any, i: number) => (
                            <div key={item.id} style={{ border: "1px solid #e4eaf6", borderRadius: "12px", overflow: "hidden" }}>
                              <button onClick={() => setLookupOpen(lookupOpen === i ? null : i)}
                                style={{ width: "100%", textAlign: "left", background: lookupOpen === i ? "#f5f8fd" : "#fff", border: "none", padding: "13px 14px", cursor: "pointer", display: "flex", alignItems: "center", gap: "8px" }}>
                                <span style={{ flex: 1, minWidth: 0 }}>
                                  <span style={{ display: "block", fontSize: "13.5px", fontWeight: 700, color: "#1a1a2e", marginBottom: "3px" }}>{item.title}</span>
                                  <span style={{ fontSize: "11px", color: "#8a94a8" }}>{item.category} · {item.createdAt ? new Date(item.createdAt).toLocaleDateString(lang === "ko" ? "ko-KR" : "en-CA") : ""}</span>
                                </span>
                                <span style={{ flexShrink: 0, fontSize: "10.5px", fontWeight: 700, padding: "3px 8px", borderRadius: "20px",
                                  background: item.status === "answered" ? "#e3f6ea" : "#fff3e0", color: item.status === "answered" ? "#1a7a43" : "#b26a00" }}>
                                  {item.status === "answered" ? (lang === "ko" ? "✓ 답변완료" : "✓ Answered") : (lang === "ko" ? "⏳ 대기중" : "⏳ Pending")}
                                </span>
                                <span style={{ flexShrink: 0, color: "#aab", fontSize: "13px", transform: lookupOpen === i ? "rotate(180deg)" : "none", transition: "transform .15s" }}>⌄</span>
                              </button>
                              {lookupOpen === i && (
                                <div style={{ padding: "0 14px 14px", borderTop: "1px solid #eef2f8" }}>
                                  <div style={{ fontSize: "11px", fontWeight: 700, color: "#5a6a85", margin: "12px 0 5px" }}>{lang === "ko" ? "내 질문" : "My Question"}</div>
                                  <div style={{ fontSize: "13px", color: "#334", lineHeight: 1.55, whiteSpace: "pre-wrap", background: "#f7f9fd", borderRadius: "8px", padding: "10px 12px" }}>{item.content}</div>
                                  <div style={{ fontSize: "11px", fontWeight: 700, color: "#5a6a85", margin: "12px 0 5px" }}>{lang === "ko" ? "답변" : "Reply"}</div>
                                  {item.status === "answered" ? (
                                    <div style={{ fontSize: "13px", color: "#1a1a2e", lineHeight: 1.6, whiteSpace: "pre-wrap", background: "#eef6ff", borderRadius: "8px", padding: "10px 12px" }}>{item.answer}</div>
                                  ) : (
                                    <div style={{ fontSize: "12.5px", color: "#8a94a8", lineHeight: 1.5 }}>{lang === "ko" ? "아직 답변이 등록되지 않았습니다. 영업일 기준 2~3일 내에 안내드립니다." : "No reply yet. We will respond within 2–3 business days."}</div>
                                  )}
                                </div>
                              )}
                            </div>
