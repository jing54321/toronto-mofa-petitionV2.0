...
const TREE = {
  ...
  visa_dual_check: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "국적 확인"], title: "⚠️ 비자 신청 전 국적 확인 필수", docs: ["📌 한국 「국적법」에 따르면:", "  ▸ 1998년 6월 14일 이후 출생자: 부모 중 한 명이 한국인이면 자동으로 한국 국적 보유", "  ▸ 1998년 6월 13일 이전 출생자: 부(父)가 한국인이면 한국 국적 보유", "⚠️ 한국 국적자는 F-4 비자 신청 불가 — 비자가 아닌 한국 여권을 신청해야 합니다"], costs: [{ label: "수수료", value: "해당 없음" }], time: "확인 후 적절한 서비스로 안내", notices: ["출생신고를 한 번도 하지 않았다면 → 가족관계 → 출생신고 메뉴", "국적선택을 하지 않았다면 → 국적 → 국적선택신고 메뉴 (만 22세 이전)", "이미 국적상실 처리 완료 → 기본증명서(상세) 확인 후 F-4 비자 신청 가능", "병역의무자(남성 만 18~37세): 국적이탈 전 병역 문제 해결 필수"], booking: "https://www.torbooking.com/book", bookingLabel: "가족관계 / 국적 상담 예약 →" },
  ...
  visa_f3_spouse: {
    ...
    docs: [
      ...
      "재외동포인 경우 추가: 기본증명서 (상세, 3개월 이내) — 국적상실·이탈 날짜 표시",
    ],
  ...
  visa_f3_child: {
    ...
    docs: [
      ...
      "F-4 소지자의 유효한 F-4 비자 사본 또는 국내거소신고증 앞뒷면 사본",
      "가족관계 입증 서류:",
      "  ▸ 자녀가 한국 국적이었던 경우: 기본증명서 + 가족관계증명서 (상세, 3개월 이내)",
      "  ▸ 출생 당시 부모 모두 캐나다 국적인 경우: Certified copy of birth registration 원본 + 사본 + 부모 여권 사본 + 부모 시민권증서",
    ],
    costs: [{ label: "수수료", value: "CAD $81 (현금, Debit, 신용카드) / 우편: Certified Cheque $81" }],
    time: "약 1~2주",
    notices: [
  ...
  visa_f4_case1_ko: {
    ...
    docs: [
      ...
      "캐나다 여권 원본 + 사본",
      "부모 여권 사본 각 1부 (사망한 경우: 사망증명서로 대체)",
      "캐나다 시민권증서 원본 + 사본 (시민권 카드·Search of Citizenship Record 불가, 취득일자 년월일 필수)",
      "본인 출생증명서 원본 + 사본 (한국 출생자: 시민권증서로 대체, 부모 이름 포함)",
      "본인 기본증명서 (상세, 주민번호 전부공개, 3개월 이내)",
      "본인 가족관계증명서 (상세, 3개월 이내)",
      "부모 기본증명서 + 가족관계증명서 각 1부 (상세, 3개월 이내)",
      "국적상실신고 접수증 (기본증명서에 미표시 시)",
      "부모 체류자격 증명서류 사본 (시민권증서/Birth Certificate/PR카드 등)",
      "RCMP 범죄경력증명서 원본 — 지문 기반, 6개월 이내",
      "  ▸ ⚠️ 지문 기반 필수 — 이름 기반·지역경찰 발급 불가",
      "  ▸ 제3국 범죄경력증명서 (최근 5년 내 타국 1년 이상 체류 시)",
    ],
    costs: [{ label: "수수료", value: "CAD $121.50 (현금, Debit, 신용카드) / 우편: Certified Cheque" }],
    time: "5~10 영업일",
    notices: [
      "⚠️ 비자 신청 전 국적상실신고 먼저 완료 필수 — Step 1: 기본증명서·가족관계증명서 신청 (영사관 신청 시 2주) → Step 2: 국적상실신고 → Step 3: 비자 신청.",
      "⚠️ 신청 가능: 부모와 함께 2018.5.1 이전 시민권 취득 후 국적상실·이탈 완료 / 병역 이행 완료 / 병역 면제.",
      "⚠️ 신청 불가: 2018.5.1 이후 병역 미이행 상태로 국적 상실·이탈 → 만 41세까지 F-4 제한.",
      "비자 유효기간: 5년 · 1회 입국 시 최대 2년 · 복수 입국.",
      "⚠️ 비자 발급일로부터 3개월 이내 입국 필수.",
  ...
  visa_f4_case2_general_ko: {
    type: "result",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "F-4 재외동포", "케이스 2"],
    title: "재외동포 비자 (F-4) — 케이스 2: 출생 복수국적자",
    docs: [
      "사증발급신청서 — 모든 항목 기재",
      "여권용 사진 1매 (영사관 장비 사용 불가)",
      "캐나다 여권 원본 + 사본",
      "부모 여권 사본 각 1부",
      "본인 출생증명서 원본 + 사본 (부모 이름 포함)",
      "한국 국적이었던 부 또는 모의 기본증명서 + 가족관계증명서 (상세, 3개월 이내)",
      "  ▸ ⚠️ 부 또는 모가 영사관에 직접 방문하여 신청 (자녀 대신 신청 불가)",
      "부모 국적상실신고 접수증 (기본증명서에 미표시 시)",
      "부모 체류자격 증명서류 사본",
      "[선택] 한국어 능력 입증 서류 — 제출 시 최대 2년 체류, 미제출 시 1년",
      "  ▸ TOPIK 1급 이상 / 사회통합프로그램 1단계 이수 / 세종학당 초급 1B 이상",
    ],
    costs: [{ label: "수수료", value: "CAD $121.50 (현금, Debit, 신용카드) / 우편: Certified Cheque" }],
    time: "5~10 영업일",
    notices: [
      "신청 자격: 출생 당시 부 또는 모가 이미 캐나다 시민권자 + 국적이탈 완료.",
  ...
  visa_f4_case2_male_ko: {
    type: "result",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "F-4 재외동포", "케이스 2 (18~59세 남성)"],
    ...
    docs: [
      ...
      "부모 체류자격 증명서류 사본",
      "RCMP 범죄경력증명서 원본 — 지문 기반, 6개월 이내",
      "  ▸ ⚠️ 지문 기반 필수 / 제3국 범죄경력증명서 (5년 내 타국 1년 이상 체류 시)",
      "[선택] 한국어 능력 입증 서류 (2년 체류 원하는 경우)",
    ],
    costs: [{ label: "수수료", value: "CAD $121.50 (현금, Debit, 신용카드) / 우편: Certified Cheque" }],
    time: "5~10 영업일",
    notices: [
      "⚠️ RCMP: 지문 기반 필수. 문의: CCRTIS-SCICTR@rcmp-grc.gc.ca",
      "⚠️ 한국어 능력 서류 미제출 시 체류기간 최대 1년.",
      "⚠️ 비자 발급일로부터 3개월 이내 입국 필수.",
    ],
    booking: "https://www.torbooking.com/book",
  ...
  visa_f4_case3_ko: {
    ...
    docs: [
      ...
      "여권용 사진 1매 — 3.5×4.5cm, 흰색 배경, 6개월 이내",
      "  ▸ ⚠️ 영사관 사진 장비 사용 불가 — 사진관 촬영 필수",
      "캐나다 여권 원본 + 사본",
      "캐나다 시민권증서 원본 + 사본",
      "  ▸ 시민권 카드·Search of Citizenship Record 불가 / 취득일자 년월일 필수",
      "본인 기본증명서 (상세, 주민번호 전부공개, 3개월 이내)",
      "본인 가족관계증명서 (상세, 3개월 이내)",
    ...
    time: "5~10 영업일",
    notices: [
      "⚠️ 비자 신청 전 국적상실신고 먼저 완료 필수 — 처리기간 약 6개월.",
  ...
  visa_visit_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "캐나다 시민권자 관광"], title: "캐나다 시민권자 — 한국 무비자 입국", docs: [], costs: [{ label: "비자 수수료", value: "없음 (무비자)" }], time: "비자 신청 불필요", notices: ["🇨🇦 캐나다 여권으로 한국 최대 6개월 무비자 체류.", "K-ETA: 2026년 12월 31일까지 캐나다 국적자 면제.", "캐나다 여권만 지참하면 됩니다."], booking: null },

  visa_c39_tourist_ko: {
    type: "result",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "관광 비자 (C-3-9)"],
    ...
    costs: [
      ...
      { label: "참고", value: "수수료 국적별 상이 — torvisa@mofa.go.kr 확인" },
    ],
    time: "약 5~10 영업일",
    notices: [
      "⚠️ C-3-9는 완전 온라인 비자가 아닙니다 — 영사관 방문 또는 우편 제출 필요.",
      "체류기간: 최대 90일. C 계열 비자로 입국 후 다른 비자로 전환 불가.",
      "⚠️ 비자 발급일로부터 3개월 이내 입국 필수.",
    ],
    booking: "https://www.torbooking.com/book",
    bookingLabel: "예약하기 (비자과) →",
  ...
  visa_transit_canadian_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "한국 경유", "캐나다 시민권자"], title: "✅ 캐나다 시민권자 — 무비자 입국 (TWOV 불필요)", docs: [], costs: [{ label: "비자 수수료", value: "없음" }], time: "사전 신청 불필요", notices: ["캐나다 시민권자는 한국 최대 6개월 무비자 입국 가능.", "TWOV는 비캐나다 국적자를 위한 제도입니다."], booking: null },

  visa_transit_ineligible_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "한국 경유", "제한 국적"], title: "❌ TWOV 불가 — 비자 필요", docs: [], costs: [{ label: "비자 필요", value: "C-3 단기방문 비자 신청" }], time: "약 5~7 영업일", notices: ["해당 국적자는 캐나다 PR·비자를 소지하더라도 TWOV 이용 불가.", "문의: 법무부 외국인 출입국 정책본부 +82-2-2100-1345"], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_transit_step2_ko: {
    type: "question",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "한국 경유 (TWOV)", "2단계"],
    question: "2단계 — 유효한 캐나다 PR카드 또는 비자 스티커가 있나요?",
    sub: "여권에 부착된 스티커 형태의 비자 또는 PR카드여야 합니다 — 전자비자(e-visa) 불가.",
    options: [
  ...
  visa_transit_no_status_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "한국 경유", "캐나다 체류자격 없음"], title: "❌ TWOV 불가 — 비자 필요", docs: [], costs: [{ label: "비자 필요", value: "C-3 단기방문 비자 신청" }], time: "약 5~7 영업일", notices: ["유효한 캐나다 PR카드 또는 비자 스티커가 있어야 TWOV 가능.", "전자비자(e-visa)는 인정되지 않습니다."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_transit_step3_ko: {
    type: "question",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "한국 경유 (TWOV)", "3단계"],
    question: "3단계 — 여정은?",
    ...
    options: [
      ...
      { id: "visa_transit_roundtrip_ko", icon: "❌", title: "캐나다 → 한국 → 캐나다 (한국만 방문 후 귀국)", desc: "다른 목적지 없이 한국만 방문" },
      { id: "visa_transit_complex_ko", icon: "✅", title: "복잡한 경유 여정 (한국 전 경유지 3일 이내)", desc: "예: 출발국 → 경유 (3일 이내) → 한국 → 자국" },
    ],
  },

  visa_transit_ok_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "한국 경유", "적합"], title: "✅ TWOV 이용 가능 (조건 충족 시)", docs: ["사전 신청 불필요 — 입국 시 확인:", "  ▸ 유효한 캐나다 PR카드 또는 비자 스티커", "  ▸ 한국 출발 30일 이내 확정 항공권", "  ▸ 최근 3년 내 한국 입국 거부 이력 없음", "  ▸ 한국 입국 전 타국 경유 시 3일 이내 체류"], costs: [{ label: "비용", value: "없음" }], time: "입국 시 심사", notices: ["체류기간: 최대 30일 (B-2 관광통과).", "⚠️ 출발 전 항공사 및 한국 출입국사무소에 확인하세요.", "문의: +82-2-2100-1345"], booking: null, onlineLink: "https://www.immigration.go.kr" },

  visa_transit_roundtrip_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "한국 경유", "불가 — 왕복"], title: "❌ TWOV 불가 — 비자 필요", docs: [], costs: [{ label: "비자 필요", value: "C-3-9 관광 비자 신청" }], time: "약 5~10 영업일", notices: ["TWOV는 한국을 '경유'하는 여정에만 해당됩니다.", "한국만 방문 후 귀국은 TWOV 해당 없음 — C-3-9 관광 비자 신청하세요."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_transit_complex_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "한국 경유", "복잡한 여정"], title: "✅ TWOV 이용 가능 — 복잡한 여정 (조건 충족 시)", docs: ["사전 신청 불필요 — 입국 시 확인:", "  ▸ 유효한 캐나다 PR카드 또는 비자 스티커", "  ▸ 한국 출발 30일 이내 확정 항공권", "  ▸ ⚠️ 한국 입국 전 경유지 체류 반드시 3일 이내"], costs: [{ label: "비용", value: "없음" }], time: "입국 시 심사", notices: ["허용 예시: 캐나다 → 한국 → 제3국 → 자국 ✅", "⚠️ 한국 입국 전 경유지 3일 초과 체류 시 TWOV 불가.", "체류기간: 최대 30일."], booking: null, onlineLink: "https://www.immigration.go.kr" },

  visa_short_term_ko: {
    type: "question",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "단기 방문"],
    question: "방문 목적은?",
  ...
  visa_c34_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "단기 방문", "출장 (C-3-4)"], title: "일반상용 비자 (C-3-4) — 단기 출장", docs: ["사증발급신청서 — SIN 번호 기재", "유효한 여권 원본 + 사본", "여권용 사진 1매", "캐나다 장기 체류비자 원본 + 사본 (캐나다 국적자가 아닌 경우)", "은행 잔고증명서 (은행 직인)", "한국 초청회사의 초청장", "출장 목적 입증서류", "한국 초청회사 사업자등록증 또는 등기부등본", "신청인 캐나다 회사의 재직증명서"], costs: [{ label: "단수 입국", value: "CAD $54 (현금, Debit, 신용카드)" }], time: "약 12~15 영업일", notices: ["🇨🇦 캐나다 시민권자는 무비자 입국 가능 — 비자 필요 여부 먼저 확인하세요.", "신청인은 캐나다 회사로부터 급여를 받아야 합니다.", "체류: 최대 90일. C 계열 비자로 입국 후 다른 비자로 전환 불가."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →", onlineLink: "https://www.visa.go.kr" },

  visa_c31_event_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "단기 방문", "행사·대회 참석 (C-3-1)"], title: "단기방문 비자 (C-3-1) — 행사·대회 참석", docs: ["사증발급신청서", "유효한 여권 원본 + 사본 (유효기간 6개월 이상)", "여권용 사진 1매", "캐나다 체류 신분 증빙서류 원본 + 사본", "주최측 초청장 (행사 목적·일정·주최자 정보 포함)", "주최측 사업자등록증", "캐나다 회사 재직증명서 또는 재학증명서"], costs: [{ label: "수수료", value: "CAD $54 (현금, Debit, 신용카드)" }], time: "약 12~15 영업일", notices: ["🇨🇦 캐나다 시민권자는 한국 무비자 입국 가능 — 비자 필요 여부 먼저 확인하세요.", "체재비를 초과하는 보수를 받기로 한 경우: C-4 단기취업 비자 신청.", "⚠️ 항공·회의 일정 등 개인 사유는 신속 발급 사유 해당 없음."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →", onlineLink: "https://www.visa.go.kr" },

  visa_c33_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "단기 방문", "의료관광 (C-3-3)"], title: "의료관광 비자 (C-3-3)", docs: ["사증발급신청서", "유효한 여권 원본 + 사본", "여권용 사진 1매", "캐나다 체류 신분 증빙서류 원본 + 사본", "한국 병원 초청장 또는 진료예약 확인서 (3개월 이내)", "한국 병원 사업자등록증", "재정 능력 증빙: 재직증명서 + 최근 2개월 잔고증명서"], costs: [{ label: "수수료", value: "CAD $54 (현금, Debit, 신용카드)" }], time: "약 2주", notices: ["🇨🇦 캐나다 시민권자는 무비자로 의료관광 가능.", "체류: 최대 90일. C 계열 비자로 입국 후 다른 비자로 전환 불가."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →", onlineLink: "https://www.visa.go.kr" },

  visa_work_ko: {
    type: "question",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "취업"],
    ...
    options: [
      ...
      { id: "visa_h1_ko", icon: "🏖️", title: "H-1 — 워킹홀리데이", desc: "만 18~35세 · 최대 2년" },
      { id: "visa_f1d_ko", icon: "💻", title: "F-1-D — 디지털 노마드 (워케이션)", desc: "외국 회사 재직 중 한국 원격근무 · 최대 1년" },
    ],
  },

  visa_e2_1_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "E-2-1"], title: "E-2-1 — 원어민 외국어 교사 비자", docs: ["사증발급신청서 (CVI 소지자용)", "유효한 캐나다 여권 원본 + 사본", "여권용 사진 1매", "서명된 고용계약서"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $81" }], time: "약 1~2주", notices: ["⚠️ 한국 고용주가 먼저 visa.go.kr에서 CVI 발급 필수.", "⚠️ 신청 가능 국적: 캐나다·미국·영국·호주·뉴질랜드·아일랜드·남아공만 해당."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_e2_2_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "E-2-2"], title: "E-2-2 — EPIK / TALK 영어보조교사 비자", docs: ["사증발급신청서", "유효한 캐나다 여권 원본 + 사본", "여권용 사진 1매", "EPIK 또는 TALK 임용통지서", "서명된 고용계약서"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $81" }], time: "약 1~2주", notices: ["⚠️ E-2-2는 정부 초청 EPIK·TALK 전용 — CVI 불필요 (임용통지서로 대체)."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_e1_e7_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "E-1~E-7"], title: "E-1~E-7 — 기타 취업 비자 (CVI 소지자)", docs: ["사증발급신청서 (CVI 소지자용)", "유효한 캐나다 여권 원본 + 사본", "여권용 사진 1매", "서명된 고용계약서"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $81" }], time: "약 1~2주", notices: ["포함: E-1 교수 / E-3 연구 / E-4 기술지도 / E-5 전문직 / E-6 예술·연예 / E-7 특정활동", "⚠️ 한국 고용주·초청기관이 먼저 visa.go.kr에서 CVI 발급 필수."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_h1_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "H-1 워킹홀리데이"], title: "H-1 — 워킹홀리데이 비자", docs: ["사증발급신청서", "유효한 여권 원본 + 사본 (유효기간 6개월 이상)", "여권용 사진 1매", "워킹홀리데이 계획서", "이력서 (CV)", "최종 학력 졸업증명서", "RCMP 지문 기반 범죄경력증명서 — 6개월 이내", "신체검사서 — 3개월 이내 (흉부X선·소변·혈액·HIV 포함)", "의료보험 증명서 — 체류 전 기간 유효 (최소 KRW 40,000,000 보장)", "은행 잔고증명서 (최소 3개월 생활비)"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $121.50" }], time: "약 1~2주. 복수 입국, 최대 2년.", notices: ["신청 자격: 캐나다 시민권자, 비자 발급 시점 만 18~35세.", "⚠️ 한국 워킹홀리데이는 평생 1회만 참여 가능.", "⚠️ 이중국적자(한국+외국): 비자 신청 불가 — 한국 여권 필요."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_f1d_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "F-1-D 디지털 노마드"], title: "F-1-D — 디지털 노마드 비자 (워케이션)", docs: ["사증발급신청서", "유효한 여권 원본 + 사본 (유효기간 6개월 이상)", "여권용 사진 1매", "재직증명서 또는 고용계약서 — 1년 이상 재직, 신청일 2주 이내 발급", "최근 3개월 급여명세서 + 최근 3개월 잔고증명서 + 최근 2년 세금신고서 (NOA)", "아포스티유 RCMP 범죄경력증명서 — 지문 기반, 3개월 이내", "의료보험 증명서 — 약 CAD $130,000 이상 보장, 체류 전 기간 유효"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $121.50" }], time: "약 1~2주. 최대 1년, 1회 연장 가능.", notices: ["신청 자격: 외국 회사에 1년 이상 재직 중인 원격근무자.", "⚠️ 한국 기업 취업 또는 한국 내 영리활동 불가."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },
  ...
  visa_c45_ko: {
    ...
    options: [
      ...
      { id: "visa_c45_dispatch_ko", icon: "🏢", title: "기업 파견", desc: "용역계약에 의한 한국 파견" },
    ],
  },

  visa_c45_camp_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "C-4-5", "영어캠프 강사"], title: "C-4-5 — 영어캠프 강사", docs: ["사증발급신청서", "유효한 여권 원본 + 사본", "여권용 사진 1매", "한국 초청기관 사업자등록증", "고용계약서 + 초청장", "평생교육시설등록증 및 신고수리증", "대학교 학위증명서 원본", "RCMP 지문 기반 범죄경력증명서 — 6개월 이내 + 영사관 공증", "대학교 성적증명서 (봉인)", "영어캠프 운영일정표 및 강의시간표"], costs: [{ label: "수수료", value: "CAD $54 (현금, Debit)" }], time: "약 2주. 최대 90일.", notices: ["⚠️ RCMP 범죄경력증명서: 지문 기반 + 영사관 공증 필수."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_c45_model_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "C-4-5", "모델·공연자"], title: "C-4-5 — 모델·공연자·연예인", docs: ["사증발급신청서", "유효한 여권 원본 + 사본", "여권용 사진 1매", "한국 초청기관 사업자등록증", "공연 개요서", "고용계약서 및 공연 개요서 (보수·인센티브 명시)", "관련 장관 추천서", "한국콘텐츠진흥원 대중문화예술기획업 등록증", "개인 추천서 및 포트폴리오"], costs: [{ label: "수수료", value: "CAD $54 (현금, Debit)" }], time: "약 2주. 최대 90일.", notices: [], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_c45_dispatch_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "취업", "C-4-5", "기업 파견"], title: "C-4-5 — 기업 파견", docs: ["사증발급신청서", "유효한 여권 원본 + 사본", "여권용 사진 1매", "한국 초청기관 사업자등록증", "캐나다 회사 재직증명서 (한국 활동 내용·기간·캐나다 회사 비용 부담 명시)", "양사 간 용역·파견 계약서"], costs: [{ label: "수수료", value: "CAD $54 (현금, Debit)" }], time: "약 2주. 최대 90일.", notices: ["⚠️ 캐나다 회사로부터 급여를 받아야 합니다."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_study_ko: {
    type: "question",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "유학·어학연수"],
  ...
  visa_d2_6_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "유학", "D-2-6 교환학생"], title: "D-2-6 — 교환학생 비자", docs: ["사증발급신청서", "유효한 캐나다 여권 원본 + 사본 (유효기간 6개월 이상)", "여권용 사진 1매", "한국 대학교 발급 표준입학허가서", "한국 기관 사업자등록증", "교환학생 관련 서류 (호스트 대학 공문·양교 협정서)", "현재 캐나다 학교 재학증명서 (최소 1학기 이상)", "재정 능력 증빙 — 은행 잔고증명서 (은행 직인)"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $81" }], time: "약 1~2주. 최대 1년.", notices: [], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_d2_8_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "유학", "D-2-8"], title: "D-2-8 — 단기 대학 과정 비자 (1년 이하)", docs: ["사증발급신청서", "유효한 캐나다 여권 원본 + 사본", "여권용 사진 1매", "한국 대학교 발급 표준입학허가서", "현재 캐나다 대학교·전문대학 재학증명서", "재정 능력 증빙 — 은행 잔고증명서"], costs: [{ label: "90일 미만", value: "CAD $54" }, { label: "90일 이상", value: "CAD $81" }], time: "약 2주. 최대 1년.", notices: ["⚠️ 한국어 어학 과정 목적이라면 D-4-1 신청.", "⚠️ D-2-8 소지자는 아르바이트 등 유급 활동 불가."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_d4_1_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "유학", "D-4-1"], title: "D-4-1 — 한국어 어학연수 비자", docs: ["사증발급신청서", "유효한 캐나다 여권 원본 + 사본", "여권용 사진 1매", "어학원 발급 입학허가서", "어학원 사업자등록증", "최종 학력 졸업(재학)증명서", "재정 능력 증빙 — 은행 잔고증명서"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $81" }], time: "약 1~2주. 최대 1년.", notices: ["신청 자격: 고등학교 졸업 이상."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_d4_3_ko: { type: "result", service: "visa", breadcrumb: ["홈", "비자 (사증)", "유학", "D-4-3"], title: "D-4-3 — 초·중·고등학교 재학 비자", docs: ["사증발급신청서 + 보호자 동의서", "유효한 캐나다 여권 원본 + 사본", "캐나다 체류 신분 증빙서류 원본 + 사본", "여권용 사진 1매", "한국 학교장 발급 입학허가서 (학교장 직인)", "최종 학력 졸업(재학)증명서", "학비 납입 영수증", "가족관계 증명서류 (출생증명서)", "은행 잔고증명서 (최근 3개월)"], costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $81" }], time: "약 1~2주. 최대 1년.", notices: ["의무교육(무상) 학교는 일반적으로 D-4-3 비자 발급 불가."], booking: "https://www.torbooking.com/book", bookingLabel: "예약하기 (비자과) →" },

  visa_marriage_ko: {
    type: "result",
    service: "visa",
    breadcrumb: ["홈", "비자 (사증)", "결혼이민 (F-6-1)"],
    title: "결혼이민 비자 (F-6-1)",
    docs: [
      "사증발급신청서 — 작성·출력",
      "혼인증명서 원본 + 사본 (반드시 상세 증명서):",
      "  ▸ 캐나다에서 혼인: Certified Copy of Marriage Registration 또는 Certified Copy of Marriage License (Legal 사이즈)",
      "  ▸ ⚠️ Certificate of Marriage (약식) 불가",
      "  ▸ 캐나다 외 국가에서 혼인: 해당 국가 혼인증명서 원본 + 영어 번역공증",
      "  ▸ 한국에만 혼인신고 된 경우: 온타리오(또는 마니토바) 변호사 Affidavit (3개월 이내)",
      "한국인 배우자(초청인)의 여권 사본",
      "초청인 이혼경력 있는 경우: 캐나다 정부 발급 이혼확인서류",
      "범죄경력증명서 (신청인 + 초청인 모두 — 면제 요건 확인 필요)",
      "건강진단서 (신청인 + 초청인 모두 — 면제 요건 확인 필요)",
      "재외동포인 경우: 기본증명서 (상세, 국적상실 날짜, 3개월 이내)",
    ],
    costs: [{ label: "수수료 (캐나다 국적자)", value: "CAD $54 (현금 또는 Debit — TAP 원칙)" }],
    time: "약 12~15 영업일",
    notices: [
      "⚠️ 신청인(외국인 배우자)이 반드시 직접 영사관 방문 — 우편 신청 불가.",
      "⚠️ 한국 혼인신고가 반드시 완료되어 있어야 합니다.",
      "체류: 단수 입국, 최대 90일 — 한국 입국 후 체류기간 연장 가능.",
      "초청인 소득 요건 (2021년 기준): 2인 가구 18,528,474원 이상 (세전, 1년간).",
      "문의: torvisa@mofa.go.kr",
    ],
    booking: "https://www.torbooking.com/book",
    bookingLabel: "예약하기 (비자과) →",
    onlineLink: "https://www.visa.go.kr",
  ...
  visa_mail_ko: {
    ...
    docs: [
      "해당 비자 구비서류 일체",
      "여권 원본 — 반드시 동봉",
      "Prepaid Xpresspost 반송봉투 (Canada Post) — 보내는 사람·받는 사람 모두 본인 주소",
      "Certified Cheque (Money Order) — PAY TO: KOREAN CONSULATE TORONTO",
      "운전면허증 앞면 복사본 (거주지 주소 확인용)",
    ],
    costs: [{ label: "우편 수수료", value: "방문 신청과 동일 — Certified Cheque만 가능" }],
    time: "방문 신청 처리기간 + 우편 배송기간",
    notices: [
      "우편 주소: Korean Consulate in Toronto (비자), 555 Avenue Road, Toronto, ON M4V 2J7",
      "전화: 416-920-3809 / 이메일: torvisa@mofa.go.kr",
      "⚠️ 우편 신청은 토론토 반경 차량 2시간 이상 거주자만 가능.",
      "⚠️ F-6-1 결혼이민 비자는 우편 신청 불가 — 반드시 본인 방문.",
      "비자 조회: visa.go.kr → '재외공관' 선택 → 여권번호·영문 성명 입력",
      "  ▸ 성명 형식: HONG GILDONG (맞음) / HONG, GILDONG (틀림)",
      "비자(VISA GRANT NOTICE) 출력: 흑백·컬러 무관, 'fit to page' 설정으로 출력",
  ...
  visa_f3_spouse_en: { type: "result", service: "visa", breadcrumb: ["Home", "Visa", "F-3 Dependent Visa", "Spouse"], title: "F-3 Dependent Visa — Spouse of F-4 Holder", docs: ["Visa Application Form (printed from visa.go.kr, with photo attached)","Valid Canadian passport — original + photocopy","1 passport-type photo","Copy of the F-4 visa holder's visa or Overseas Korean Resident Card (거소증) — front & back","Marriage certificate — Korean marriage registration (혼인관계증명서, Detailed, within 3 months), OR Canadian marriage registration","Family Relationship Certificate of both spouses (Detailed) — within 3 months"], costs: [{ label: "Visa Fee", value: "CAD $81 (Cash, Debit, Credit Card) / Mail: Certified Cheque $81" }], time: "Approx. 1–2 weeks", notices: ["Stay period: up to 1 year (within the F-4 holder's visa validity).","⚠️ Visa valid for 3 months from issue date — must enter Korea within this period or visa is void.","Marriage certificate: If married in Canada, must submit Certified Copy of Marriage Registration or Certified Copy of Marriage License (Legal size) — Certificate of Marriage short form NOT accepted.","Mail applications accepted — include Prepaid Xpresspost return envelope for passport.","⚠️ If you are of Korean heritage yourself, you may be eligible to apply for F-4 directly."], booking: "https://www.torbooking.com/book" },
  visa_f3_child_en: { type: "result", service: "visa", breadcrumb: ["Home", "Visa", "F-3 Dependent Visa", "Minor Child"], title: "F-3 Dependent Visa — Minor Child (Under 18) of F-4 Holder", docs: ["Visa Application Form (printed from visa.go.kr, with photo attached)","Valid passport — original + photocopy","1 passport-type photo","Copy of the F-4 visa holder's visa or Overseas Korean Resident Card (거소증) — front & back","Child's birth certificate — Certified Copy of Birth Registration","Parent's Family Relationship Certificate or Marriage Certificate (Detailed) — within 3 months"], costs: [{ label: "Visa Fee", value: "CAD $81 (Cash, Debit, Credit Card) / Mail: Certified Cheque $81" }], time: "Approx. 1–2 weeks", notices: ["Minor children: ages 0–18.","Stay period: up to 1 year (within F-4 holder's visa validity).","⚠️ Visa valid for 3 months from issue date — must enter Korea within this period or visa is void.","Mail applications accepted — include Prepaid Xpresspost return envelope for passport."], booking: "https://www.torbooking.com/book" },
  ...
  visa_visit_transit_en: {
    ...
    options: [
      ...
      { id: "visa_c39_tourist_en", icon: "🌏", title: "Tourism / Short-Term Stay — Non-Canadian national (with Canadian PR or visa)", desc: "C-3-9 Tourist Visa required — fee varies by nationality" },
  ...
  visa_c39_tourist_en: {
    type: "result",
    service: "visa",
    breadcrumb: ["Home", "Visa", "No Korean Heritage", "Tourism Visa (C-3-9)"],
  ...
  visa_c31_event_en: {
    ...
    costs: [{ label: "Visa Fee", value: "CAD $54 (Cash, Debit, or Credit Card)" }],
...
const page = (TREE as any)[pageId] ?? { type: "home" };
  ...
  const EN_ROUTE_MAP = {
    ...
    visa_ko_heritage_yes: "visa_heritage_yes_en",
    visa_ko_heritage_unsure: "visa_heritage_unsure_en",
    visa_ko_heritage_no: "visa_heritage_no_en",
    visa_heritage_yes: "visa_heritage_yes_en",
    visa_heritage_unsure: "visa_heritage_unsure_en",
    visa_heritage_no: "visa_heritage_no_en",
    visa_f4_ko: "visa_f4_en",
    visa_f4_case1_ko: "visa_f4_case1_en",
    visa_f4_case2_ko: "visa_f4_case2_en",
    visa_f4_case2_general_ko: "visa_f4_case2_general_en",
    visa_f4_case2_male_ko: "visa_f4_case2_male_en",
    visa_f4_case3_ko: "visa_f4_case3_en",
    visa_f4_family: "visa_f4_family_en",
    visa_f3_spouse: "visa_f3_spouse_en",
    visa_f3_child: "visa_f3_child_en",
    visa_dual_check: "visa_dual_check_en",
    visa_visit_ko: "visa_visit_en",
    visa_c39_tourist_ko: "visa_c39_tourist_en",
    visa_transit_ko: "visa_transit_en",
    visa_transit_canadian_ko: "visa_transit_canadian_en",
    visa_transit_ineligible_ko: "visa_transit_ineligible_en",
    visa_transit_step2_ko: "visa_transit_step2_en",
    visa_transit_no_status_ko: "visa_transit_no_status_en",
    visa_transit_step3_ko: "visa_transit_step3_en",
    visa_transit_ok_ko: "visa_transit_ok_en",
    visa_transit_roundtrip_ko: "visa_transit_roundtrip_en",
    visa_transit_complex_ko: "visa_transit_complex_en",
    visa_short_term_ko: "visa_short_term_en",
    visa_c34_ko: "visa_c34_en",
    visa_c31_event_ko: "visa_c31_event_en",
    visa_c33_ko: "visa_c33_en",
    visa_work_ko: "visa_work_en",
    visa_e2_1_ko: "visa_e2_1_en",
    visa_e2_2_ko: "visa_e2_2_en",
    visa_e1_e7_ko: "visa_e1_e7_en",
    visa_h1_ko: "visa_h1_en",
    visa_f1d_ko: "visa_f1d_en",
    visa_c45_ko: "visa_c45_en",
    visa_c45_camp_ko: "visa_c45_camp_en",
    visa_c45_model_ko: "visa_c45_model_en",
    visa_c45_dispatch_ko: "visa_c45_dispatch_en",
    visa_study_ko: "visa_study_en",
    visa_d2_6_ko: "visa_d2_6_en",
    visa_d2_8_ko: "visa_d2_8_en",
    visa_d4_1_ko: "visa_d4_1_en",
    visa_d4_3_ko: "visa_d4_3_en",
    visa_marriage_ko: "visa_marriage_en",
    visa_mail_ko: "visa_mail_en",
