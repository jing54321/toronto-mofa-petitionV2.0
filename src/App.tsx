...
const TREE = {
  ...
  nationality_renounce_start: {
    ...
    options: [
      { id: "nationality_renounce_male", icon: "👨", title: "남성", desc: "만 18세 되는 해 3월 31일까지 신고 필수 — 기간 도과 시 병역 해소 후 가능" },
  ...
  nationality_renounce_male_over: {
    type: "result",
    service: "nationality",
    breadcrumb: ["홈", "국적", "국적이탈신고", "남성", "기간 도과"],
    title: "⚠️ 국적이탈 기간 도과 — 예외적 허가 신청 필요",
    docs: [],
  ...
  nationality_renounce_exception: {
    ...
    title: "예외적 국적이탈 허가 — 병역미필 기간 도과 남성 (국적법 제14조의2)",
    docs: [
      "국적이탈허가 신청서 (양식)",
    ...
    notices: [
      ...
      "신청 요건: 외국 출생 또는 6세 미만 이주 후 계속 외국 거주 + 기간 도과에 책임 묻기 어려운 사정.",
  ...
  military_cert_start: {
    ...
    question: "발급 방법을 선택하세요",
    sub: "나라사랑 이메일 또는 공동인증서가 있으면 온라인으로 즉시 발급 가능합니다.",
    options: [
      { id: "military_cert_online", icon: "💻", title: "온라인 발급", desc: "나라사랑 이메일 또는 공동인증서로 즉시 발급" },
      { id: "military_cert_visit", icon: "🏛️", title: "영사관 방문 발급", desc: "방문 전 영사관 문의 권장" },
    ],
  },
  ...
  military_cert_online: {
    ...
    docs: [
      "나라사랑 이메일로 발급:",
      "  ▸ 병무청 누리집(www.mma.go.kr) → 병무민원 → 국외여행/체재 → 국외체재자 병적증명서 발급",
      "  ▸ 나라사랑 이메일: 병역판정검사 시 본인확인 후 발급된 이메일로 본인확인",
      "공동인증서로 발급:",
      "  ▸ 정부24(www.gov.kr) → 병적증명서 검색 후 발급",
    ],
    costs: [{ label: "수수료", value: "무료" }],
    time: "즉시",
    notices: [
      "영사관 방문 없이 온라인으로 즉시 무료 발급 가능합니다.",
      "국외체재자 병적증명서 발급 서비스: 2021.6.9부터 시행.",
      "국문 병적증명서만 발급 — 외국 제출용은 번역공증(공증 메뉴) 별도 필요.",
    ],
    booking: null,
    onlineLink: "https://www.mma.go.kr",
  },
  ...
  military_cert_visit: {
    type: "result",
    service: "military",
    breadcrumb: ["홈", "병역", "병적증명서 발급", "영사관 방문"],
    title: "병적증명서 영사관 방문 발급",
    docs: [
      "방문 전 영사관 전화 문의 권장 (416-920-3809)",
      "본인 유효한 한국 여권 원본",
      "캐나다 체류자격 증빙서류 원본",
    ],
    costs: [{ label: "수수료", value: "무료" }],
    time: "방문 당일",
    notices: [
      "온라인(나라사랑 이메일 또는 공동인증서)으로 발급 가능한 경우 영사관 방문 불필요합니다.",
      "국문 병적증명서만 발급 — 외국 제출용은 번역공증(공증 메뉴) 별도 필요.",
    ],
    booking: "https://www.torbooking.com/book",
    bookingLabel: "예약하기 (병역 → 병적증명서) →",
  },
